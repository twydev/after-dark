...
That's it! Everything else is optional. Read on to learn more about specific features and how to customize the theme. And, when you're ready, here are instructions to [run After Dark on AWS with HTTP/2 enabled](https://habd.as/zero-to-http-2-aws-hugo/).
...
Issues have been disabled for this repo. If you feel passionate something needs to be changed please feel free to submit a pull with your suggested changes. For a showcase of derivative works head to the [After Dark wiki](https://github.com/comfusion/after-dark/wiki#derivative-works).
