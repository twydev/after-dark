...
When you're ready to host, **save money over using Netify** by [turning your site into a JAMstack](https://habd.as/zero-to-http-2-aws-hugo/) site with Amazon Web Services and receive your first year free.
