...
A number of sites and themes have been created based on After Dark. To [view them](https://github.com/comfusion/after-dark/wiki#derivative-works) head to the After Dark wiki.
