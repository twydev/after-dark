...
This project is licensed under the ISC License. See the [LICENSE](https://github.com/comfusion/after-dark/blob/master/LICENSE) file for the full license text.
