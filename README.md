...
This project is licensed under the MIT License. See the [LICENSE](https://github.com/comfusion/after-dark/blob/master/LICENSE) file for the full license text.
