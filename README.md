...
Because post images are often one of the first things users often see when visiting your site After Dark take some extra steps to load them in a performant manner. Techniques used include [Low-Quality Image Placeholders](https://www.afasterweb.com/2016/08/31/low-quality-blur-in/), [Lazy Loading](#lazy-loading) and responsive images using the `srcset` and `sizes` attributes.
